    ...
    public partial class SeedingDataDemo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                    ...
                    insert into Users(Username,Password, SaltKey,Email,Mobile)
                    select 'Demo',
                    ...
                    Insert into Cities(Name,LastUpdatedBy,LastUpdatedDate,Country)
                    ...
                    insert into Properties(SellRent,Name,PropertyTypeId,BHK,FurnitureTypeId,Price,BuiltArea,CarpetArea,Address,
                    Address2,CityId,FloorNo,TotalFloor,ReadyToMove,MainEntrance,Security,Gated,Maintenance,EstPossessionOn,Age,Description,PostedOn,PostedBy,LastUpdatedOn,LastUpdatedBy)
                    select 
                    1, --Sell Rent
                    'White House Demo', --Name
                    (select Id from PropertyTypes where Name='Apartment'), --Property Type ID
                    2, --BHK
                    (select Id from FurnitureTypes where Name='Fully'), --Furnishing Type ID
                    1800, --Price
                    1400, --Built Area
                    900, --Carpet Area
                    '6 Street', --Address
